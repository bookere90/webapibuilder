    ...
    function formatUrl(tabUrl){
        ...
        //     let tabUrl = getTabUrl;
            ...
            if(regex.test(tabUrl)){
                ...
                $("body").html("<h6 id='errorMessage'>This extension must be used in the context of a Dynamics Environment</h6>").css({"background-color":"red"}).css({"text-align":"center"});
                $("#errorMessage").css({"padding-top": "35%"});
            }
        }
